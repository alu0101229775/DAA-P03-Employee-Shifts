...
namespace DAA_P03.Parte1_Ordenamiento.Modelo
{
    ...
    public class SolucionMergeSort : Solucion
    {
        ...
        /// <summary>
        /// Constructor que inicializa una solución MergeSort.
        /// </summary>
        ...
        public SolucionMergeSort(int start, int final, int middle, int[] vector)
        {
            if (vector == null)
        ...
        {
            return $"MergeSort - Rango [{Start}-{Final}], Middle: {Middle}, Tamaño: {Tamaño}, Ordenado: {EsValida}";
        }
